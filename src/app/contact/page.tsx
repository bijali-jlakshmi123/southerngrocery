...
import { Mail, Phone, MapPin, Clock, MessageSquare, Send, ChevronRight, Facebook, Instagram, Twitter, MessageCircle } from 'lucide-react';
...
export default function ContactPage() {
  ...
  const contactInfo = [
    { icon: <Phone size={24} />, title: 'Call Support', value: '+44 XXXX XXXXXX', subtitle: 'Mon-Sat, 9AM-6PM' },
    { icon: <Mail size={24} />, title: 'Email Us', value: 'hello@southernspices.uk', subtitle: 'Reply within 24h' },
    { icon: <MessageCircle size={24} />, title: 'WhatsApp', value: 'Chat Now', subtitle: 'Instant Support', link: 'https://wa.me/XXXXXXXXXX' },
    { icon: <MapPin size={24} />, title: 'Main Depot', value: 'London, UK', subtitle: 'Serving UK-wide' },
  ];
      ...
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
           ...
           <h1 className="text-5xl md:text-7xl font-heading font-black text-slate-900 tracking-tight leading-[1.1] mb-8">
             We're Here for <span className="text-secondary italic">Your Spices</span>
           </h1>
           <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto">
             Have a question about a product or need help with your delivery? Our team of Kerala grocery experts is ready to help you.
           </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
           ...
           <div className="lg:col-span-5 space-y-8">
                 ...
                 {contactInfo.map((info, i) => (
                   ...
                   >
                      ...
                      <div className="min-w-0">
                         <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1">{info.title}</div>
                         <div className="text-lg font-heading font-black text-slate-900 truncate">{info.value}</div>
                         <div className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-tighter opacity-60">{info.subtitle}</div>
                      </div>
                   </motion.div>
                 ))}
              </div>
              ...
              <div className="bg-slate-900 rounded-5xl p-10 text-white space-y-8 relative overflow-hidden">
                 ...
                 <h3 className="text-2xl font-heading font-black relative z-10">Follow Our Spice Journey</h3>
                 <div className="flex gap-4 relative z-10">
                    {[Instagram, Facebook, Twitter].map((Social, i) => (
                      <button key={i} className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center hover:bg-white/20 transition-all active:scale-90">
                         <Social size={20} />
                      </button>
                    ))}
                 </div>
                 <div className="pt-8 border-t border-white/10 flex items-center gap-4">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-slate-400">Join 15k+ followers</span>
                 </div>
              </div>
           </div>
           ...
           <div className="lg:col-span-7 bg-white p-10 md:p-14 rounded-5xl border border-slate-50 shadow-premium relative overflow-hidden group">
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                 ...
                 <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] ml-4">Message Subject</label>
                    <input 
                      required
                 ...
                 <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] ml-4">Tell Us More</label>
                    <textarea 
                      required
                      rows={5}
        ...
        <div className="mt-32 pt-24 border-t border-slate-100">
           <div className="text-center mb-16">
              <h2 className="text-4xl font-heading font-black text-slate-900 mb-4">Quick <span className="text-primary">Answers</span></h2>
              <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Commonly asked questions in the spice community</p>
           </div>
           
           <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {[
                { q: "Where do you deliver?", a: "We deliver across the entire UK, including major cities like London, Manchester, Birmingham, and Edinburgh." },
                ...
                { q: "Are your vegetables fresh?", a: "Yes! Our vegetables are sourced daily to ensure you receive only the freshest quality authentic Kerala produce." },
                { q: "Do you offer bulk discounts?", a: "We certainly do! Please contact us using the form above for bulk order quotes." },
              ].map((faq, i) => (
                <div key={i} className="bg-slate-50 p-8 rounded-4xl border border-transparent hover:border-slate-100 transition-all group">
                   <div className="flex items-center gap-4 mb-4">
                      <div className="text-secondary group-hover:scale-110 transition-transform"><ChevronRight size={20} className="font-bold" /></div>
